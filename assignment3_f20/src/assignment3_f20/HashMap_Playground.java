...
public class HashMap_Playground {
	...
	public static void main(String[] args) {
		...
		//    System.out.println(hm.hasKey("Bill")); // expect true
		//    System.out.println(hm.hasKey("Zorro")); // expect false
		//    System.out.println(Arrays.toString(hm.getKeys()));
		//    System.out.println(hm.get("Bill").getIdNum());
		//    System.out.println(hm.get("Zed").getScore());
		//    System.out.println(hm.get("Jenny").getAge());
		//    System.out.println(hm.maxKey());
		//    System.out.println(hm.minKey());
		//    hm.remove("Alan");
		//    System.out.println(Arrays.toString(hm.getKeys()));
		//    hm.remove("Zed");
		//    System.out.println(Arrays.toString(hm.getKeys()));
		...
		//    System.out.println(hm.lambda());
		//    System.out.println(Arrays.toString(hm.getKeys())); 
		HashMap hm = new HashMap_imp(2);
		Value v1 = new Value_imp(1, 50, 20);
		Value v2 = new Value_imp(1, 100, 20);
