...
*/
  ...
  public static void main(String[] args) {
   ...
   Value v4 = new Value_imp(45678, 55.70, 35);
    ...
    tm.put("kappa", v1); 
    System.out.println(tm.hasKey("kappa"));
    //TMCell print_root = tm.getRoot();
    //System.out.println(print_root.getKey());
    ...
    tm.put("omega", v4); 
    tm.put("zeta", v4);
    Arrays.stream(tm.getKeys()).forEach(System.out::println);
    tm.remove("sigma");
    //System.out.println(tm.put("kappa",v2)); 
    //System.out.println(tm.height());
    //System.out.println(print_root.getKey());
